...
#define CMD_LINK_DIR   "/usr/local/bin"     // like: /bin/v-cmd-show-all
...
#define CMD_ARGS_MAX_LEN        64      // Max character length of a command parameter
...
typedef struct cmd_data {
    ...
    int  argc;                                          // cmd number, start at 0
