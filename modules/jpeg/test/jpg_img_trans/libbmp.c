...
enum bmp_error bmp_header_write (const bmp_header *header,
                  FILE             *img_file)
{
	if (header == NULL)
	{
...
enum bmp_error bmp_header_read (bmp_header *header,
                 FILE       *img_file)
{
	if (img_file == NULL)
	{
...
enum bmp_error bmp_img_write (const bmp_img *img,
               FILE *img_file)
{	
	if (img_file == NULL)
	{
...
enum bmp_error bmp_img_read (bmp_img    *img,
              const char *filename)
{
